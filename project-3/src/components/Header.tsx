    ...
    return (
        <div className="head">
            <div className='md:bg-properTeal flex justify-center'>
                ...
                <div>
                    <Link to="/login"><button type="button" role="logout" className="inline-block absolute top-3 right-2 md:mt-6 md:mb-6 px-6 py-2.5 bg-transparent text-darkTeal md:text-white font-medium text-s leading-tight rounded 
